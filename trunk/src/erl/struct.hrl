...
-define(UNDERLYING, #underlying{px = 99.0}).

-define(UNDERLYING_SIDE, #side{underlyings = [?UNDERLYING]}).

-define(LONG_UNDERLYING, 
		#position{description = "Long Underlying on Pg 15", long = ?UNDERLYING_SIDE}).

-define(SHORT_UNDERLYING, 
		#position{description = "Short Underlying on Pg 15", short = ?UNDERLYING_SIDE}).

-define(LONG_CALL, 
		#position{description = "Long Call on Pg 16",
...
-define(CALL_BULL_SPREAD,
		#position{description = "Call Bull Spread on Pg 23",
				  long = #side{calls = [#option{px = 9.35, strike = 90.0}]}, 
				  short = #side{calls = [#option{px = 2.7, strike = 100.0}]}}).

-define(PUT_BEAR_SPREAD,
		#position{description = "Put Bear Spread on Pg 24",
...
-define(PUT_RATIO_VERTICAL_SPREAD,
		#position{description = "Put Ratio Verical Spread on Pg 140",
...
-define(LONG_STRANGLE,
		#position{description = "Long Strangle on Pg 143",
...
-define(LONG_BUTTERFLY,
		#position{description = "Long Butterfly on Pg 146",
...
-define(SHORT_BUTTERFLY,
		#position{description = "Short Butterfly on Pg 146",
...
-define(LONG_CALL_XMAS_TREE,
		#position{description = "Long Call Christmas Tree on Pg 158",
				  long = #side{calls = lists:duplicate(10, (?MARCH_OPTION)#option{px = 5.82, strike = 95.0})},
				  short = #side{calls = lists:duplicate(10, (?MARCH_OPTION)#option{px = 2.69, strike = 100.0}) ++
										lists:duplicate(10, (?MARCH_OPTION)#option{px = 0.95, strike = 105.0})}}).

-define(LONG_PUT_XMAS_TREE,
		#position{description = "Long Put Christmas Tree on Pg 158",
...
-define(SHORT_CALL_XMAS_TREE,
		#position{description = "Short Call Christmas Tree on Pg 158",
...
-define(SHORT_PUT_XMAS_TREE,
		#position{description = "Short Put Christmas Tree on Pg 158",
...
-define(LONG_IRON_BUTTERFLY, 
		#position{description = "Long Iron Butterfly on Pg 159",
...
-define(SHORT_IRON_BUTTERFLY,
		#position{description = "Short Iron Butterfly on Pg 159",
...
-define(LONG_CALL_CONDOR,
   		#position{description = "Long Condor on Pg 159",
...
-define(LONG_PUT_CONDOR,
		#position{description = "Long Put Condor on Pg 159",
...
-define(SHORT_CALL_CONDOR,
		#position{description = "Short Call Condor on Pg 159",
...
-define(SHORT_PUT_CONDOR,
		#position{description = "Short Put Condor on Pg 159",
